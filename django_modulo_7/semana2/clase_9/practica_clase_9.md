...
> — _Fuente: OWASP Top 10 Report (2025 Prediction)_
...
> — _Fuente: Gartner Cloud Infrastructure Report (2024)_
...
## 🛠️ Tarea 3: El Comando Mágico `seed_cv`
...
`tu_app/management/commands/seed_cv.py`

### El Código:

El comando debe permitir ejecutar `python manage.py seed_cv` y realizar lo siguiente:
